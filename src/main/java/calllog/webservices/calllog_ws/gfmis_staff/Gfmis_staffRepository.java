...
public interface Gfmis_staffRepository extends CrudRepository<Gfmis_staff, Long> {
    ...
    String GET_HDUSER = "select calllogin,null as callpassword,callusername from gfmis_staff where callposition ='2' and callstatus ='1' order by calllogin" ;
    @Query(value = GET_HDUSER, nativeQuery = true)
    Collection<Gfmis_staff> findHD();

    String GET_TECUSER = "select calllogin,null as callpassword,callusername from gfmis_staff where callposition ='4' and callstatus ='1' order by calllogin" ;
